...
export class RedisCoreModule {
  ...
  static forRoot(options: RedisModuleOptions, connection?: string): DynamicModule {
    ...
    return {
      ...
      providers: [redisOptionsProvider, redisConnectionProvider, RedisHealthIndicator],
      exports: [redisOptionsProvider, redisConnectionProvider, RedisHealthIndicator],
    };
  }
  ...
  public static forRootAsync(options: RedisModuleAsyncOptions, connection: string): DynamicModule {
    ...
    return {
      ...
      providers: [...this.createAsyncProviders(options, connection), redisConnectionProvider, RedisHealthIndicator],
